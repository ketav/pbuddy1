...
INSERT INTO `user_detail` VALUES ('Arashdeep Singh','asingh58@sapient.com','male','Gurgaon, Haryana',2147483647,NULL),('Arashdeep Sidhu','arashdeeps@gmail.com','male','Gurgaon, Haryana',726424688,NULL),('Ketav Sharma','ketavsharma@gmail.com','male','Mandi, India',1040570136,21);
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `pb_GetDetailsN`(IN `start` INT(50), IN `dataSize` INT(10),IN `userId` INT(50), IN `SortOrder` VARCHAR(50))
BEGIN 
	select a.photo_url,a.avg_rating,a.rating_received,b.name,b.email_id,b.user_id,a.photo_id from photo_detail a , user_detail b
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `proc_IN` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `proc_IN1` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `proc_IN1`(IN var1 INT)
BEGIN
    SELECT var1 + 2 AS result;
END ;;
DELIMITER ;
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `var_proc` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
/*!50003 SET character_set_client  = utf8 */ ;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `var_proc`(IN paramstr VARCHAR(20))
BEGIN  
...
-- Dump completed on 2013-11-23 17:58:43
